...
**Best for**: 技术文档、学术报告、双语简报、研究论文
**Feel**: 严谨、精确、信息密度高，像 arXiv 论文的排版
**Auto-select keywords**: briefing, academic, research, bilingual, technical report, whitepaper
...
:root {
  ...
  --content-gap: 1.6vh;
  --headline-hero-size: 8vw;
  --headline-xl-size: 5vw;
  --headline-md-size: 1.8vw;
  --subheadline-size: 2.4vw;
  --body-size: max(13px, 1.05vw);
  --lead-size: 1.4vw;
  --margin-content: 5%;
  --grid-gap-h: 2vw;
  --grid-gap-v: 2.5vh;
  --stat-nb-size: 4.5vw;
  --stat-label-size: max(9px, 0.7vw);
}
```
